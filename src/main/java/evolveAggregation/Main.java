...
import evolveAggregation.groundingEngine.*;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        semanticRegistry.loadRulesFromFile(rulesPath, true); // Assuming identical rules
        ...
        System.out.println("==================================================");
        Main.Metrics semanticMetrics = evaluateModel(semanticEngine, semanticRegistry, testPath, N, allKnownFacts);
     ...
     */
    private static Main.Metrics evaluateModel(GroundingEngine engine, RuleRegistry registry, String testPath, int N, Set<String> allKnownFacts) {
        ...
        if (totalPredictions > 0) {
            ...
            return new Main.Metrics(h1, h5, h10, finalMrr);
        }

        return new Main.Metrics(0,0,0,0);
    }
