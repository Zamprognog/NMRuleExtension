...
\author{Stefan Schlobach}{Vrije Universiteit Amsterdam, The Netherlands \and Hybrid Intelligence Consortium, The Netherlands}{k.s.schlobach@vu.nl@vu.nl}{https://orcid.org/0000-0002-3282-1597}{}
...
\begin{table}[]
    \centering
    \caption{Analyzed datasets. \textcolor{red}{Restrictions are abbreviated as f (functionality), if (inverse functionality), d (domain) and r (range). YAGO4.5-10-flip is the derived variant described in Section \ref{sec:flip}, used only for the inverse-functionality analysis.}}
    \begin{tabular}{l|c|c|c|c}
         ...
         \textcolor{red}{YAGO4.5-10-flip} & \textcolor{red}{3.997M} & \textcolor{red}{f,if,d,r} & \textcolor{red}{3.22M} & \textcolor{red}{16.2k} \\
    \end{tabular}
    \label{tab:datasets}
\end{table}
...
\textcolor{red}{Rules are mined on YAGO4.5-10-flip with AnyBURL in the `Full' setting, but with two deviations from the configuration used for the main experiments. First, the mining is restricted to the two inverse-functional heads (\texttt{birthPlaceOf}, \texttt{deathPlaceOf}), so that every mined rule --- and therefore every materialized triple --- is subject to the constraint under study. Second, the confidence threshold is lowered from 0.1 to 0.01 and the snapshot extended from 100s to 300s, yielding 20,562 rules. The lower threshold is necessary because rules with these two heads are individually low-confidence: in an unrestricted run over the same graph they are almost entirely absent from the top-1/5/10\% of the sorted rule set, which would leave the constraint untested. As a consequence of both deviations, the absolute figures of this experiment are not directly comparable with those of Tables \ref{tab:mat_anyburl_10_30} and \ref{tab:mat_amie_10_30}; the comparison of interest is between the standard and the non-monotonic condition within the experiment, which share the same rule set.}
...
\textcolor{red}{The rule counts make the pruning visible: of the 2057 rules in the top 10\%, 1530 produce triples in the standard condition and 1035 under the extension, so roughly a third of the productive rules are stopped entirely as they only predict exceptions. The added cost is modest at this scale, from 368s to 385s at the 10\% threshold.}
...
\setlength{\tabcolsep}{4pt}
\renewcommand{\arraystretch}{1.12}
\caption{Materialization of YAGO4.5-10-flip with AnyBURL rules restricted to inverse-functional heads, \textbf{standard} condition. `invf', `func', `dom' and `ran' are the inconsistent triples according to, respectively, inverse functionality, functionality, domain and range; `\# inc' is the number of distinct inconsistent triples and `sem' the ratio of consistent triples over the materialized ones. \textcolor{red}{`\# applied', `\# target' and `time' are as in Table \ref{tab:mat_anyburl_10_30}.}}
\label{tab:mat_flip_standard}
\begin{tabular}{l | r r r r r r r r r r}
\toprule
\% & \textcolor{red}{\# applied} & \textcolor{red}{\# target} & \# triples & invf & func & dom & ran & \# inc & sem & \textcolor{red}{time} \\
\midrule
1\%  & \textcolor{red}{155}  & \textcolor{red}{206}  & 2777  & 1992  & 0 & 0 & 8   & 2000  & 0.28 & \textcolor{red}{28s} \\
5\%  & \textcolor{red}{756}  & \textcolor{red}{1029} & 40492 & 21461 & 0 & 0 & 321 & 21778 & 0.46 & \textcolor{red}{189s} \\
10\% & \textcolor{red}{1530} & \textcolor{red}{2057} & 72518 & 45407 & 0 & 0 & 355 & 45756 & 0.37 & \textcolor{red}{368s} \\
\bottomrule
\end{tabular}
\end{table}
...
\% & \textcolor{red}{\# applied} & \textcolor{red}{\# target} & \# triples & invf & func & dom & ran & \# inc & sem & \textcolor{red}{time} \\
\midrule
1\%  & \textcolor{red}{104}  & \textcolor{red}{206}  & 785   & 8    & 0 & 0 & 0 & 8    & 0.99 & \textcolor{red}{40s} \\
5\%  & \textcolor{red}{519}  & \textcolor{red}{1029} & 19417 & 703  & 0 & 0 & 0 & 703  & 0.96 & \textcolor{red}{202s} \\
10\% & \textcolor{red}{1035} & \textcolor{red}{2057} & 30122 & 3340 & 0 & 0 & 0 & 3340 & 0.89 & \textcolor{red}{385s} \\
\bottomrule
\end{tabular}
\end{table}
