...
\usepackage{placeins}
\usepackage{xcolor}
% TODO(OWL2Bench): claims invalidated by adding OWL2Bench as a 5th dataset.
% Rewrite the wrapped text, then delete the wrapper (and this macro).
\newcommand{\FALSIFIED}[1]{\textcolor{red}{#1}}
...
We compare our approach with the baselines from two rule-miners (AMIE3, AnyBURL) and on \FALSIFIED{four} large-scale KGs representing varying domains and curation levels, assessing how they perform with both standard rank-based LP metrics and semantic-aware metrics.
...
\begin{table}[]
    ...
    \begin{tabular}{l|c|c|c|c}
         ...
         OWL2Bench & 750k & f,invf,d,r & 375k & 9.87k \\
    \end{tabular}
    \label{tab:datasets}
\end{table}
...
\addlinespace
5\% & \# applied & 1 & - & 23 & 5 \\
5\% & \# target & 20 & - & 1067 & 1067 \\
5\% & \# inc & 25 & - & 3288 & 0 \\
5\% & triples & 25 & - & 6.0k & 2.7k \\
5\% & sem & 0.00 & - & 0.45 & 1.0 \\
5\% & time & 1s & - & 13s & 12s \\
\addlinespace
10\% & \# applied & 7 & 4 & 198 & 52 \\
10\% & \# target & 39 & 39 & 2134 & 2134 \\
10\% & \# inc & 3210 & 0 & 37571 & 0 \\
10\% & triples & 8.2k & 5.0k & 113k & 76k \\
10\% & sem & 0.61 & 1.0 & 0.67 & 1.0 \\
10\% & time & 1s & 1s & 23s & 23s \\
\bottomrule
\end{tabular}
\end{minipage}%
\end{table}
...
% --- CSKG-490K ---
% L4 is not available for CSKG-490K in Table~\ref{tab:mat_amie_10_30}; plotted at 0 for scale consistency.
\nextgroupplot[title={CSKG-490K}]
...
\end{groupplot}
\end{tikzpicture}
\caption{Semantic consistency for AMIE rules as a function of the percentage of applied rules (1\%, 5\%, 10\%), extracted from Table~\ref{tab:mat_amie_10_30}. Grouped bars (per percentage): L3 std, L3 nmr, L4 std, L4 nmr. (L4 is not available for CSKG-490K and is shown at 0.)}
...
\midrule
\multicolumn{9}{c}{OWL2Bench} \\
\midrule
& \multicolumn{4}{c|}{CP rules} & \multicolumn{4}{c}{Full rules} \\
\cmidrule(lr){2-5} \cmidrule(lr){6-9}
Ruleset & sem@10 & hits@1 & hits@10 & mrr & sem@10 & hits@1 & hits@10 & mrr \\
\midrule
AnyBURL & 0.9925 & 0.1769 & 0.3395 & 0.2252 & 0.9941 & 0.1775 & 0.3275 & 0.2223 \\
AnyBURL nmr & 1.0 & 0.1704 & 0.3212 & 0.2142 & 1.0 & 0.1767 & 0.3188 & 0.2187 \\
AMIE & 0.9794 & 0.1166 & 0.1685 & 0.1343 & 0.9865 & 0.1437 & 0.2521 & 0.1791 \\
AMIE nmr & 1.0 & 0.1097 & 0.1487 & 0.1224 & 1.0 & 0.1376 & 0.2368 & 0.1684 \\
\bottomrule
\end{tabular}
\end{table}
...
\paragraph{Datasets.} We extract rules from the following Knowledge Graphs, which are selected as they come with a defined schema, summarized in Table \ref{tab:datasets}. \FALSIFIED{As it can be noted from the table, while our method implements inverse functionality, we could not find a dataset taht included such restriction:}
...
\begin{itemize}
    ...
    \item \FALSIFIED{TODO: add OWL2Bench here --- a synthetic OWL2 reasoning benchmark; the only dataset in this study declaring an inverse-functional property (\texttt{isHeadOf}).}
\end{itemize}
