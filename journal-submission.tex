...
\supplement{Source code is hosted at the following GitHub repository \url{https://github.com/Zamprognog/NMRuleExtension}, which includes the full supplementary material statement.}%optional, e.g. related research data, source code, ... hosted on a repository like zenodo, figshare, GitHub, ...
