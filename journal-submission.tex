...
\begin{table}[]
    ...
    \begin{tabular}{l|c|c|c|c}
         ...
         YAGO4.5-10-flip & 3.997M & if,(i,d,r) & 3.22M & 16.2k \\
    \end{tabular}
    \label{tab:datasets}
\end{table}
...
\begin{itemize}
    ...
    \item Hetionet \cite{himmelstein_systematic_nodate} a large, heterogeneous biomedical Knowledge Graph that integrates data from a collection of public databases to connect various entities like genes, compounds, and diseases.
