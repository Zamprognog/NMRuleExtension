...
\begin{itemize}
    ...
    \item CSKG-490K: CSKG-2.0 \cite{dessi_cs-kg_2025} is an automatically generated Knowledge Graph collecting statements from 15 million research papers from the field of Computer Science, based on an expert-defined and evaluated ontology with a high granularity of properties. It provides multiple LP-targeted splits, among which CSKG-490K is generated by collecting all triples with support $\geq5$.
