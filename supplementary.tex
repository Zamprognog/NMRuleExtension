...
\suppurl{Artifact/Zenodo snapshot}{10.5281/zenodo.22125113}
...
\begin{itemize}
    ...
    \texttt{schema:deathPlace} (55,941). 
    \item Data: every $(s,r,o)$ is rewritten as $(o,r^{-1},s)$ in the train/valid/test TSVs and in
    the full \texttt{.nt} graph. Split sizes are unchanged (3,222,052 / 16,273 / 16,273) and the
    entity types file is copied verbatim
    \item T-Box: the axioms of the original property are dropped; the inverse is declared \texttt{rdf:Property} and
